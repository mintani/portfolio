...
const NAV_LINK_CLASS =
  "font-poppins relative text-[0.95rem] font-medium tracking-wide text-[#2a3149] after:absolute after:bottom-[-4px] after:left-0 after:h-[2px] after:w-full after:origin-left after:scale-x-0 after:bg-[#2a3149] after:transition-transform after:duration-300 hover:after:scale-x-100";
